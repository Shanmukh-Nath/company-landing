...
export default function Header() {
  ...
  const handleClick = (menu, ref) => {
    setAnchorEl(ref.current);
    setClickedMenu(clickedMenu === menu ? "" : menu);
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Left side - Products, Services, Careers */}
            ...
            {navItems.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  {/* Enhanced Dropdown with Preview Panel */}
                          ...
                          <ClickAwayListener onClickAway={handleClose}>
                            <Paper
                              ...
                              sx={{
                                ...
                                boxShadow: "0 8px 32px rgba(169, 36, 39, 0.12)",
                            ...
                            >
                              ...
                              <MenuList sx={{ minWidth: 260, py: 1 }}>
                                {item.submenu.map((sub, subIndex) => (
                                  ...
                                  >
                                    <MenuItem
                                      onMouseEnter={() =>
                                        item.hasPreview && setHoveredItem(sub)
                                      }
                                      onClick={() => {
                              ...
                              {/* Preview Panel - Only for Products and Services */}
                              <AnimatePresence mode="wait">
